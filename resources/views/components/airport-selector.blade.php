<div class="airport-selector relative inline-flex flex-col justify-center relative text-gray-500">
    ...
    <div class="relative">
        ...
        <ul class="list top-0 absolute bg-white border border-gray-100 w-full">
...
window.addEventListener("load",()=>{
    document.querySelectorAll('.airport-selector');
    for(const component of  document.querySelectorAll('.airport-selector'))
    {
        ...
        const search =  async event=>{
           ...
           if(event.target.value.length < 3){ removeAllChildNodes(ul);
