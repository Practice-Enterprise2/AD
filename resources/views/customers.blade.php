...
<div class="tableContainer">
    <table class="tableCust">
        <thead>
            ...
            <tr>
                <th><input type="text" id="searchInputName" onkeyup="filterTable()" placeholder="Search by name..."></th>
                <th><input type="text" id="searchInputLastName" onkeyup="filterTable()" placeholder="Search by last name..."></th>
                <th><input type="text" id="searchInputEmail" onkeyup="filterTable()" placeholder="Search by email..."></th>
                <th><input type="text" id="searchInputPhone" onkeyup="filterTable()" placeholder="Search by phone..."></th>
                <th><input type="text" id="searchInputAddress" onkeyup="filterTable()" placeholder="Search by address..."></th>
                <th><input type="text" id="searchInputRegion" onkeyup="filterTable()" placeholder="Search by region..."></th>
                <th><input type="text" id="searchInputCountry" onkeyup="filterTable()" placeholder="Search by country..."></th>
                <th><input type="text" id="searchInputVatNumber" onkeyup="filterTable()" placeholder="Search by VAT number..."></th>
                <th>Action</th>
            </tr>
        </thead>
        <tbody>
...
<script>
  ...
  var inputName, inputLastName, inputEmail, inputPhone, inputAddress, inputRegion, inputCountry, inputVatNumber, filter, table, tr, td, i, txtValue;
  ...
  for (i = 1; i < tr.length; i++) {
    ...
    if (tdName || tdLastName || tdEmail || tdPhone || tdAddress || tdRegion || tdCountry || tdVatNumber) {
