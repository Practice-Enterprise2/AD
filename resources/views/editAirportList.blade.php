...
<form action="/editAirport" method="POST" autocomplete="off">
    ...
    <input type="text" maxlength="3" name="iata_code" value="{{ $data['iata_code'] }}" required> <br> <br>
    ...
    <input type="text" name="land" value="{{ $data['land'] }}" required> <br> <br>

    <label for="address_id">Address ID</label> <br>
    <input type="number" maxlength="20" name="address_id" value="{{ $data['address_id'] }}" required> <br> <br>
