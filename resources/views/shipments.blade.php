<x-app-layout>
  ...
  <!-- response modal -->
  <div class="fixed inset-0 z-10 hidden overflow-y-auto text-black dark:text-white" id="responseModal">
    <div class="flex min-h-screen items-center justify-center p-4 text-center">
      <div class="fixed inset-0 bg-black opacity-75"></div>
      <div
        class="relative mx-auto w-full max-w-md rounded bg-white p-6 shadow-lg dark:bg-gray-500">
        <h1 class="mb-4 text-2xl font-bold">Response</h1>
        <p class="mb-4">  </p>
        <div class="relative bottom-0 flex w-full justify-center pb-6">
          <button
            class="ml-2 rounded bg-gray-500 px-4 py-2 font-bold text-white hover:bg-gray-600 dark:bg-gray-700 hover:bg-gray-900"
  ...
  <!-- Modal -->
  <div class="fixed inset-0 z-10 hidden overflow-y-auto text-black dark:text-white" id="cancelModal">
    <div class="flex min-h-screen items-center justify-center p-4 text-center">
      <!-- Modal Background -->
      <div class="fixed inset-0 bg-black opacity-75"></div>
      <!-- Modal Content -->
  ...
  <div class="flex justify-centerdark:text-white">
    <div class="w-full">
        ...
        <table
          ...
          <thead>
            <tr class="bg-gray-400 dark:bg-gray-800">
              <th
                class="border-b border-gray-400 px-6 py-3 text-left text-sm font-bold uppercase "
                ...
                <tr
                  ...
                  <td
                    ...
                    <script>
                      ...
                      var closeResponseModal = document.getElementById('closeResponseModal');
                      // cancel modal
