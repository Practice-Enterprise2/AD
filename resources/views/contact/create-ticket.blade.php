<x-app-layout>
  <div class="mx-auto max-w-screen-md px-4 py-8 lg:py-16">
    ...
    <form method="POST" action="{{ route('submitted-ticket') }}">
      ...
      <input type="text" name="name" id="name" placeholder="First and last name" class="mb-4 ark:shadow-sm-light block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
        value="{{ old('name') }}" required>

      <label for="email" class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300">Email address</label>
      <input type="text" name="email" id="email" placeholder="name@example.com" class="mb-4 ark:shadow-sm-light block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
        value="{{ old('email') }}" required>

      <label for="issue" class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300">Issue</label>
      ...
      <textarea name="description" id="description" placeholder="Write an explanation..." rows="6"
      ...
      <button type="submit" class="rounded-lg bg-primary-700 px-5 py-3 text-center text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:w-fit">Submit</button>
    </form>
  </div>
</x-app-layout>