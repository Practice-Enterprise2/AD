<x-guest-layout>
  <form method="POST" action="{{ route('register') }}">
    ...
    <div class="mt-4">
      ...
      <x-text-input id="street" class="mt-1 block w-full"
    ...
    <div class="mt-4">
      ...
      <x-text-input id="house_number" class="mt-1 block w-full"
        type="text" name="house_number" required
    ...
    <div class="mt-4">
      ...
      <x-text-input id="city" class="mt-1 block w-full"
