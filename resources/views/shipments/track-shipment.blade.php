...
<div class="flex items-center justify-center my-4">
    <div class="w-3/5 mx-auto bg-white p-6 rounded-md shadow-md">
        ...
        <h2 class="text-lg font-medium mb-4">Track Shipment</h2>
        <div id="myMap" style="width:60%;height:300px;" class="m-2 border border-black"></div>
...
<script type='text/javascript'>
    ...
    function GetMap() {
        ...
        // VIEW RANGE
        map.setView({ bounds: Microsoft.Maps.LocationRect.fromLocations([leuven, mechelen, brussels, istanbul]) });
    }
