<div>
    ...
    <input wire:model="search" type="text" class="mx-auto" placeholder="Search invoice code..."/>
    ...
    <div class="mx-auto">
            <table class="w-[1000px] text-center border-solid border-2">
                <th>ID</th>
                <th>Shipment ID</th>
                <th>Invoice Code</th>
                <th>Due Date</th>
                ...
                @if(@isset($invoices))
                    ...
                    <tr class="border-solid border-2">
                        ...
                        <td>
                        <form method="post" action="invoices_list/details" accept-charset="UTF-8">
                            @csrf
