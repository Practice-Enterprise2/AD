<div class="flex justify-center">
    <table>
        <tr class="border-2 border-black dark:border-white">
            <th class="border-2 border-black dark:border-white">Shipment Destination</th>
        ...
        <tr class="border-2 border-black dark:border-white h-full">
            <td class="border-2 border-black dark:border-white">{{ $pickup->shipment->destination_address->country }},{{ $pickup->shipment->destination_address->city }}</td>
            <td class="border-2 border-black dark:border-white">{{ $pickup->time }}</td>
            <td class="border-2 border-black dark:border-white">{{ $pickup->address->street }}</td>
            <td class="border-2 border-black dark:border-white">{{ $pickup->address->house_number }}</td>
            <td class="border-2 border-black dark:border-white">{{ $pickup->address->postal_code }}</td>
            <td class="border-2 border-black dark:border-white">{{ $pickup->address->city }}</td>
