...
class WaypointController extends Controller
{
    ...
    public function store(Shipment $shipment): View
    {
        $this->validate(request(), [
            ...
            'waypoints.*.street' => ['required', 'string', 'regex:/^[A-Za-z0-9\s]+$/'],
            'waypoints.*.house_number' => 'required|string',
            'waypoints.*.postal_code' => ['required', 'string', 'regex:/^[A-Za-z0-9\s]+$/'],
            'waypoints.*.city' => ['required', 'string', 'regex:/^[A-Za-z\s]+$/'],
            'waypoints.*.region' => ['required', 'string', 'regex:/^[A-Za-z\s]+$/'],
            'waypoints.*.country' => ['required', 'string', 'regex:/^[A-Za-z\s]+$/'],
        ],
            [
                'waypoints.required' => 'Please enter at least one waypoint.',
                'waypoints.*.street.required' => 'Please enter a street for waypoint.',
                'waypoints.*.street.string' => 'Please enter a valid street for waypoint.',
                'waypoints.*.street.regex' => 'Please enter a valid street for waypoint.',
                'waypoints.*.house_number.required' => 'Please enter a house number for waypoint.',
                'waypoints.*.house_number.string' => 'Please enter a valid house number for waypoint.',
                'waypoints.*.postal_code.required' => 'Please enter a postal code for waypoint.',
                'waypoints.*.postal_code.string' => 'Please enter a valid postal code for waypoint.',
                'waypoints.*.postal_code.regex' => 'Please enter a valid postal code for waypoint.',
                'waypoints.*.city.required' => 'Please enter a city for waypoint.',
                'waypoints.*.city.string' => 'Please enter a valid city for waypoint.',
                'waypoints.*.city.regex' => 'Please enter a valid city for waypoint.',
                'waypoints.*.region.required' => 'Please enter a region for waypoint.',
                'waypoints.*.region.string' => 'Please enter a valid region for waypoint.',
                'waypoints.*.region.regex' => 'Please enter a valid region for waypoint.',
                'waypoints.*.country.required' => 'Please enter a country for waypoint.',
                'waypoints.*.country.string' => 'Please enter a valid country for waypoint.',
