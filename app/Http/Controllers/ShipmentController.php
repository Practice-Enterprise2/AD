...
class ShipmentController extends Controller
{
    ...
    public function store(): View|RedirectResponse
    {
        ...
        $this->validate(request(), [
            'receiver_name' => Shipment::VALIDATION_RULES['name'],
            'receiver_email' => Shipment::VALIDATION_RULES['email'],
            'source_street' => Shipment::VALIDATION_RULES['street'],
            'source_housenumber' => Shipment::VALIDATION_RULES['house_number'],
            'source_postalcode' => Shipment::VALIDATION_RULES['postal_code'],
            'source_city' => Shipment::VALIDATION_RULES['city'],
            'source_region' => Shipment::VALIDATION_RULES['region'],
            'source_country' => Shipment::VALIDATION_RULES['country'],
            'destination_street' => Shipment::VALIDATION_RULES['street'],
            'destination_housenumber' => Shipment::VALIDATION_RULES['house_number'],
            'destination_postalcode' => Shipment::VALIDATION_RULES['postal_code'],
            'destination_city' => Shipment::VALIDATION_RULES['city'],
            'destination_region' => Shipment::VALIDATION_RULES['region'],
            'destination_country' => Shipment::VALIDATION_RULES['country'],
            'weight' => Shipment::VALIDATION_RULES['weight'],
            'length' => Shipment::VALIDATION_RULES['length'],
            'width' => Shipment::VALIDATION_RULES['width'],
            'height' => Shipment::VALIDATION_RULES['height'],
            'status' => Shipment::VALIDATION_RULES['status'],
        ],
            [
