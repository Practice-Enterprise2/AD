...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::controller(EmployeeContractController::class)->group(function () {
        Route::get('/employees/{employee}/contracts/create', 'create')->name('employees.contracts.create');
        Route::post('/employees/{employee}/contracts', 'store')->name('employees.contracts.store');
    });
